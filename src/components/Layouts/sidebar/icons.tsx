...
export const stores = StorefrontOutlined ;
export const drivers = DirectionsCarOutlined ;
export const categories = CategoryOutlined ;
export const brands = LocalOfferOutlined ;
export const popularDestinations = LocationOnOutlined ;
export const attributes = LabelOutlined ;
export const airports = AirportShuttleOutlined ;
export const items = LocalMallOutlined ;
export const liveMaps = AddLocationOutlined ;
export const orders = ShoppingCartOutlined ;
export const giftCards = CardGiftcardOutlined ;
export const coupons = RedeemOutlined ;
export const report = ReportOutlined;
export const settings = SettingsOutlined;
export const payments = CreditCardOutlined;
export const cmsPages = DescriptionOutlined;
export const emailTemplates = EmailOutlined;
export const onboardingScreens = ScreenLockPortraitOutlined;
export const notifications = NotificationsOutlined;
export const vehicleSettings = DirectionsCarOutlined;
export const rentalService = CommuteOutlined;
export const cabService = LocalTaxiOutlined;
export const parcelService = LocalShippingOutlined;
export const onDemandService = LocalShippingOutlined;
export const subscriptionPlan = AccountBalanceOutlined;


/** Section & Service Icon (Outlined Grid) */
export function SectionService(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <rect x={3} y={3} width={8} height={8} rx={1} stroke="currentColor" strokeWidth={1.5} />
      <rect x={13} y={3} width={8} height={5} rx={1} stroke="currentColor" strokeWidth={1.5} />
      <rect x={3} y={13} width={5} height={8} rx={1} stroke="currentColor" strokeWidth={1.5} />
      <path d="M10 13h11M10 17h11" stroke="currentColor" strokeWidth={1.5} />
    </svg>
  );
}

/** Access Control Icon (Outlined Lock) */
export function AccessControl(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <rect x={4} y={10} width={16} height={10} rx={2} stroke="currentColor" strokeWidth={1.5} />
      <path d="M8 10V6a4 4 0 118 0v4" stroke="currentColor" strokeWidth={1.5} />
    </svg>
  );
}

/** User & Customer Icon (Outlined Two People) */
export function UserCustomer(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <circle cx={16} cy={9} r={4} stroke="currentColor" strokeWidth={1.5} />
      <circle cx={6} cy={9} r={3} stroke="currentColor" strokeWidth={1.5} />
      <path d="M2 19c0-2 2.5-4 4.5-4s4.5 2 4.5 4" stroke="currentColor" strokeWidth={1.5} />
      <path d="M12 19c0-2.5 3.5-4 6-4s6 1.5 6 4" stroke="currentColor" strokeWidth={1.5} />
    </svg>
  );
}

/** Owners & Vendors Icon (Outlined Handshake) */
export function OwnersVendors(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M3 9l4-4 2 2-2 2 2 2-1.5 1.5L3 9zM21 9l-4-4-2 2 2 2-2 2 1.5 1.5L21 9zM8.5 13.5L12 18l3.5-4.5L12 9l-3.5 4.5z"
        stroke="currentColor"
        strokeWidth={1.5}
...
/** Providers Icon (Outlined Briefcase) */
export function Providers(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
